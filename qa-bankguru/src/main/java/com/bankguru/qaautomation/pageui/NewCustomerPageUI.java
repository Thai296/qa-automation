...
//	public static final String HEADER_TEXT = "//p[text()='Add New Customer']";
...
//	public static final String GENDER_MALE_CHECKBOX = "//input[@value='m']";
//	public static final String GENDER_FEMALE_CHECKBOX = "//input[@value='f']";
//	public static final String DOB_DATEPICKER = "//input[@name='dob']";
